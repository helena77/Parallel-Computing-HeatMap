 ...
 * author: Helena
 * version: 1
 * This class is used to test the GeneralScan2
 */
...
/**
 * Little test of hw5.GeneralScan2
 */
public class ScanTest2 extends GeneralScan2<Double, Double> {

	public ScanTest2(List<Double> raw) {
		super(raw);
	}
	...
	public static void main(String[] args) {
		...
		ScanTest2 scanner = new ScanTest2(data);
